...
s = s.replace("costPrice: cost, price: Number(newPart.price || 0), minStock:", "costPrice: cost, markupPercent, price: sellingPrice, minStock:")
...
if 'markupPercent, price: sellingPrice' not in s:
    raise SystemExit('Markup percentage was not stored on inventory items')
