...
new_state = """  const [newRepair, setNewRepair] = useState({
    customerName: '', phone: '', citizenshipNo: '',
    customerPhoto: '', citizenshipPhoto: '',
    deviceType: 'Mobile (Unlock)', model: '', totalCost: '', discountType: 'percentage', discountValue: '', paidAmount: '', password: '', issue: '', warrantyMonths: ''
  });"""
...
old_reset = """    setNewRepair({ customerName: '', phone: '', citizenshipNo: '', customerPhoto: '', citizenshipPhoto: '', deviceType: 'Mobile (Unlock)', model: '', totalCost: '', paidAmount: '', issue: '', warrantyMonths: '' });"""
new_reset = """    setNewRepair({ customerName: '', phone: '', citizenshipNo: '', customerPhoto: '', citizenshipPhoto: '', deviceType: 'Mobile (Unlock)', model: '', totalCost: '', discountType: 'percentage', discountValue: '', paidAmount: '', password: '', issue: '', warrantyMonths: '' });"""
